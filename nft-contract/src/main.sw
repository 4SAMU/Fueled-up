...
configurable {
    ...
    MAX_SUPPLY: u64 = 1000_000_000_000,
}
...
impl SRC3 for Contract {
    ...
    fn mint(recipient: Identity, sub_id: SubId, amount: u64) {
        ...
        // award_points(recipient, storage.minting_points.try_read().unwrap_or(0));
    ...
    fn burn(sub_id: SubId, amount: u64) {
        ...
        // award_points(caller, storage.reselling_points.try_read().unwrap_or(0));
